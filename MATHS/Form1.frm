...
RS11.Close
Set RS11 = Nothing
'MsgBox "Calculation Fully Done and Record Saved", vbInformation
End Sub
...
DB2.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\MATHS\maths.mdb;Persist Security Info=False"
 ...
 If rs.State = adStateOpen Then rs.Close
    rs.Open "SELECT * FROM Maths2", DB2, 3, 3
...
Do Until RS11.EOF
    ...
    Static_Power = ((Val(Rolling_Torgue) * Val(RS11!revolution_of_roll_Nm)) / 0.93) * 1.025
...
If num1 = Int(num1) Then
 '   MsgBox "Even no " & h
    k2 = 0.95 'constant
    'MsgBox "This is the small b of " & h + 1 & " = " & d19 & " it will be used to calculate = " & h
    'get the H
    h18 = k2 * d19
    MsgBox h & " " & h18 & " " & d19
    ...
    'search for area using the value
        If RS2.State = adStateOpen Then RS2.Close
        RS2.Open "SELECT * FROM Maths2 where Stand = '" & h & "'", DB2, 3, 3
         j = Val(RS2!Area)
         S18 = Val(RS2!SValue)
         '   MsgBox "SValue = " & S18
            k18 = 0.45 'constant
            ...
            xa4 = xa - xa3
            finalB = 2 * ((xa4) ^ 0.5)
           ' MsgBox "b value " & finalB
        RS2.Close
        Set RS2 = Nothing
            'i left calculation of width of the groove
            ...
            h1 = h + 1
             If RS3.State = adStateOpen Then RS3.Close
            RS3.Open "SELECT * FROM maths2 where stand = '" & h1 & "'", DB2, 3, 3
            ...
            RS2.Close
            Set RS2 = Nothing
            d19 = 0 'u will put new value here from ODD
Else
  '  MsgBox "Odd no " & h
    K1 = 1.2 'constant
    'search for area using the value
  ...
  '          MsgBox "Area = " & J
   ...
   '         MsgBox h17
      ...
      '      MsgBox finalr17
            finalB = d19 + 1
     '       MsgBox "This is the small b of " & h & " = " & d19
        RS2.Close
        Set RS2 = Nothing
        'i left calculation of width of the groove
        'update the record to db
        If RS2.State = adStateOpen Then RS2.Close
            ...
            h3 = h + 1
            If RS3.State = adStateOpen Then RS3.Close
            RS3.Open "SELECT * FROM maths2 where stand = '" & h3 & "'", DB2, 3, 3
...
'take another loop to get the angles in degree
'If RS11.State = adStateOpen Then RS11.Close
'RS11.Open "SELECT * FROM Maths2", DB3, 3, 3
 '   j = 19
 '   RS11.MoveFirst
  '  Do Until RS11.EOF
   ...
   ' total_angle_of_bite_degree = (Val(RS11!angle_of_bite) / Val(total_angle_of_bite)) * 360
    
    '   saves the angle of bites in degree
   '     If RS14.State = adStateOpen Then RS14.Close
    '    RS14.Open "SELECT * FROM maths2 where stand = '" & j & "'", DB3, 3, 3
    '        RS14!angle_of_bite_deg = Val(total_angle_of_bite_degree)
    '    RS14.Update
